        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-600 hover:text-[#E89B5A] transition-colors duration-300">
          ...
          {/* Menús y Recetas */}
          <div>
            <h3 className="text-lg font-semibold mb-6 text-[#4A4A3F]">Menús y Recetas</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/menu" className="text-gray-600 hover:text-[#E89B5A] transition-colors duration-300 text-sm">
                  Menús IDDSI
                </Link>
              </li>
              <li>
                <Link href="/recetas" className="text-gray-600 hover:text-[#E89B5A] transition-colors duration-300 text-sm">
                  Recetas Adaptadas
                </Link>
              </li>
              <li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <Link href="/privacy" className="text-gray-500 hover:text-[#E89B5A] transition-colors duration-300 text-sm">
                Política de Privacidad
              </Link>
              <Link href="/terms" className="text-gray-500 hover:text-[#E89B5A] transition-colors duration-300 text-sm">
                Términos de Servicio
              </Link>
              <Link href="/accessibility" className="text-gray-500 hover:text-[#E89B5A] transition-colors duration-300 text-sm">
                Accesibilidad
              </Link>
            </div>
          </div>
